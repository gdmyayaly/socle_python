-- Dump du schéma de la base `dsr_trppu_aa`
-- 22 objet(s) — schéma uniquement (sans données)

CREATE DATABASE IF NOT EXISTS `dsr_trppu_aa`;
USE `dsr_trppu_aa`;
...
DROP TABLE IF EXISTS `trppu_trafic_site`;
...
-- FIN DE L'EXPORT — 0 ligne(s) au total, 0.048s