...
@Component({
  selector: 'app-trppu-neutralisation-peak',
  templateUrl: './trppu-neutralisation-peak.component.html',
  styleUrls: ['./trppu-neutralisation-peak.component.css']
})
export class TrppuNeutralisationPeakComponent implements OnChanges {
  ...
  private loadPeriodes(): void {
    ...
    this.paramService.getNeutralisationsPeak(this.siteId).subscribe(data => {
      this.periodes = data;
