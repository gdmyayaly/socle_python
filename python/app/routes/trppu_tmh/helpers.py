...
async def upsert_tmh_row(
    ...
    *,
    ...
    `motif` : justification libre d'une modif manuelle / exclusion (None = effacé).
...
async def upsert_tmh_rows(
    ...
    moyenne_journaliere, moyenne_hebdo, exclusion et (optionnel) manuel, motif (cf. TmhUpsert).
