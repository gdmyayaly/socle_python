...
# Dump de schéma représentatif : en-tête commenté, CREATE DATABASE/USE, bascule des
# contraintes, DROP + CREATE TABLE. C'est la forme que prennent les scripts de `db/`.
DUMP_EXTRAIT = """\
-- =============================================================================
-- Dump du schema de la base `app_demo`
-- =============================================================================
...
def test_split_dump_de_schema():
    """Découpage d'un dump de schéma complet : compte et mots-clés attendus."""
