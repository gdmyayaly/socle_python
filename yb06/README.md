...
Module **YB06** : une **application console** (pas de serveur HTTP, pas de port), bâtie sur
...
docker compose run --rm yb06 s3-check --prefixe ""
docker compose run --rm yb06 charger-cles-repartition 1
```
...
```json
{"app_datetime": "2026-07-31T07:49:35.874Z", "app_ccx": "dsr", "app_env": "sdev", "app_ptf": "build", "app_tm": "yb06", "app_version": "1.0.0", "severity_label": "INFO", "app_message": "Fin chargement (lignes=1240, duration_ms=8421.0)", "id_traitement": 12345, "name": "app.main", "filename": "main.py", "lineno": 158}
```
